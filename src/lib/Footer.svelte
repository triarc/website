<div class="bg-white">
  <div class="max-w-screen-xl mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
    <div class="mt-8 md:mt-0 md:order-1 sm:order-1">
        ...
        <dl class="mt-8 text-base text-gray-500">
          ...
          <div class="mt-6">
            ...
            <dd class="flex">
              ...
              <span class="ml-3">
                <a class="underline" href="tel:+41789466951"> +41 78 946 69 51 </a> <span class='pl-2'>(Mo-Fr 9:00 - 18:00)</span>
              </span>
            </dd>
          </div>
          <div class="mt-6">
            ...
            <dd class="flex">
              ...
              <span class="ml-3">
                <a href="mailto:development@triarc-labs.com" class="underline">development@triarc-labs.com</a>
              </span>
            </dd>
          </div>
          <div class="mt-6">
            ...
            <dd class="flex">
              ...
              <span class="ml-3">
                <a href="mailto:support@triarc-labs.com" class="underline">support@triarc-labs.com</a>
              </span>
            </dd>
          </div>
        </dl>
      ...
      <div class='flex flex-col items-end'>
        ...
        <div class='m-5 flex'>
          <a href="https://ch.linkedin.com/company/triarc-laboratories" target='_blank' class="underline">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class='flex-shrink-0 h-6 w-6 text-gray-400' viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
          </a>
