    ...
    <div class="space-y-8 sm:space-y-12">
      <div class="space-y-5 sm:mx-auto sm:max-w-xl sm:space-y-4 lg:max-w-5xl">
        ...
        <p class="text-xl leading-7 text-gray-200">
          Unsere Software macht uns stolz. Elegante, einfache, wohl überlegte Lösungen sind unser Ziel.
          Dabei passen wir die Technologie unserem Kunden an – nicht umgekehrt. Unsere Ingenieure bringen ein breites
          Fachwissen mit und beherrschen alle gängigen Programmiersprachen. So können Sie Projekte über die Grenzen einer solchen Sprache hinweg zum Erfolg führen.
        </p>
      </div>
