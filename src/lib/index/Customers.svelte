<div class="bg-white grayscale">
  <div class="text-center max-w-screen-xl mx-auto py-24 md:py-32 px-4 sm:px-6 lg:px-8">
    ...
    <div class="mt-6 grid grid-cols-2 gap-0.5 md:grid-cols-3 lg:mt-8">
      <a href="https://walo.ch" target="_blank" class="col-span-1 flex items-center justify-center py-8 px-8 filter grayscale">
        <img height="80" class="max-h-16" src="/img/customer/walo-logo.svg" loading="lazy" alt="walo" />
      </a>
      <a href="https://www.kibag.ch" target="_blank" class="col-span-1 flex items-center justify-center py-8 px-8 filter grayscale">
        <img height="80" class="max-h-20" src="/img/customer/kibag-logo.svg" loading="lazy" alt="kibag" />
      </a>
      <a href="https://riwax.ch/" target="_blank" class="col-span-1 flex items-center justify-center py-8 px-8 filter grayscale">
      ...
      <a href="https://www.ideesport.ch/" target="_blank" class="col-span-1 flex items-center justify-center py-8 px-8 ">
        <picture class="max-h-12 filter grayscale">
      ...
      <a href="https://www.srf.ch/" target="_blank" class="col-span-1 flex items-center justify-center py-8 px-8 filter grayscale">
      ...
      <a
        ...
        class="col-span-1 flex items-center justify-center py-8 px-8 filter grayscale"
      >
        <img height="80" class="max-h-16 filter invert	" src="/img/customer/wettstein-logo.png" loading="lazy" alt="wettstein" />
      </a>
