<div class="bg-white grayscale">
  <div class="text-center max-w-screen-xl mx-auto py-24 md:py-32 px-4 sm:px-6 lg:px-8" id="customers">
    ...
    <div class="mt-6 grid grid-cols-2 gap-0.5 md:grid-cols-3 lg:mt-8">
      <a href="https://walo.ch" target="_blank" class="col-span-1 flex items-center justify-center py-8 px-8 filter">
      ...
      <a href="https://riwax.ch/" target="_blank" class="col-span-1 flex items-center justify-center py-8 px-8 filter">
      ...
      <a href="http://www.glb.ch/" target="_blank" class="col-span-1 flex items-center justify-center py-8 px-8 filter">
        <img height="80" class="max-h-16" src="/img/customer/glb-logo.svg" loading="lazy" alt="glb" />
      </a>
      <a href="http://www.ebl.ch/" target="_blank" class="col-span-1 flex items-center justify-center py-8 px-8 filter">
