...
{#if content}
    <div class="bg-white">
        <div class="flex flex-col lg:flex-row">
            ...
            >
                <div
                        class="flex max-w-full lg:max-w-sm min-w-sm flex-col items-center gap-x-8 px-16 lg:px-8 lg:ml-auto"
                >
                                ...
                                {#if category.posts}
                                    {#each category.posts as post}
                                        <div class="max-w-sm flex flex-row">
                                            <a href="/stories/{post.slug}" class="break-inside-avoid flex flex-col group rounded-md">
                                                <div class="relative rounded-xl rounded-b-none h-60 overflow-hidden shadow">
                                                    <img
                                                            ...
                                                            class="object-cover rounded-xl rounded-b-none overflow-hidden block h-auto max-w-auto w-full object-center group-hover:opacity-75"
                                                    />
                                                    <div class="absolute bg-opacity-20 top-0 left-0 w-full h-full rounded-md" />
                                                </div>
                                                <div class="px-4 py-3 bg-blue-triarc bg-opacity-10 flex flex-col justify-between rounded-t-none h-60 rounded-xl shadow">
