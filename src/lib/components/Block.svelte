...
<div class="bg-white">
  <div class="bg-green-triarc pb-20 sm:pb-24 xl:pb-0">
    <div class="mx-auto flex max-w-7xl flex-col items-center gap-y-10 gap-x-8 px-8 sm:gap-y-8 lg:px-8 xl:flex-row xl:items-stretch">
      <div class="-mt-8 w-full max-w-2xl xl:-mb-8 xl:w-96 xl:flex-none">
        <div class="relative aspect-[1/1.2] h-full md:-mx-8 xl:mx-0 xl:aspect-auto">
          <img class="absolute inset-0 h-full w-full rounded-2xl bg-gray-800 object-cover shadow-2xl" src="{content.quote.image}" alt="{content.quote.person}">
        </div>
      </div>
