...
<div
  class="{quote.highlight
    ...
    : 'alternating'} pb-20 sm:pb-24 md:pb-0 group"
>
  <!--  <div-->
  ...
  >
    <div
      class="mx-auto -mt-8 md:-mx-4 lg:-mx-8 w-full max-w-[337.5px] lg:max-w-[375px] xl:max-w-[412.5px] md:-mb-8 md:w-full md:flex-none xl:h-[550px] lg:h-[500px] h-[450px] md:place-self-end"
    >
    ...
    <div class="w-full md:flex-auto md:pt-24 md:pb-12 group-even:lg:pr-8 group-odd:lg:pl-8 lg:px-8">
      ...
      >
        ...
        <p>&ldquo; {@html quote.content} &rdquo;</p>
      </blockquote>
      <div class="mt-8 text-base {quote.highlight ? 'text-gray-900' : 'text-gray-600'}">
