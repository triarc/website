...
<div class="even:bg-white odd:bg-gray-100 py-24 sm:py-32 z-10 ">
    ...
    <div class="mx-auto mt-16 max-w-7xl px-6 sm:mt-5 md:mt-10 lg:px-8">
        <dl class="mx-auto grid max-w-2xl grid-cols-1 gap-x-6 gap-y-3 text-base leading-7 text-gray-600 lg:mx-0 lg:max-w-none lg:grid-cols-2 md:grid-cols-2 lg:gap-x-4 lg:gap-y-8">
