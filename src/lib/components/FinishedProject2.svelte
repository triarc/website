...
<div class="bg-white py-24 sm:py-32">
    ...
    <div class="relative overflow-hidden pt-8">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <img src="{imageSource}" alt="App screenshot" class="mb-[-12%] rounded-xl shadow-2xl ring-1 ring-gray-900/10" width="2432" height="1442">
    ...
    <div class="mx-auto mt-16 max-w-7xl px-6 sm:mt-20 md:mt-12 lg:px-8">
        <dl class="mx-auto grid max-w-2xl grid-cols-1 gap-x-6 gap-y-3 text-base leading-7 text-gray-600 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:gap-x-4 lg:gap-y-8">
            <div class="overflow-hidden rounded-lg">
                <div class="px-4 py-5 sm:p-6">
            <div class="relative pl-0 col-span-1">
                <dt class="inline font-semibold text-gray-900 pl-9">
                    <svg class="absolute left-1 top-1 h-6 w-6" xmlns="http://www.w3.org/2000/svg" height="1.25em" viewBox="0 0 576 512"><!--! Font Awesome Pro 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
            ...
            <div class="relative pl-0 col-span-1">
                <dt class="inline font-semibold text-gray-900 pl-9">
                    <svg class="absolute left-1 top-1 h-6 w-6" xmlns="http://www.w3.org/2000/svg" height="1.25em" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
