  ...
  <div class="max-w-screen-xl mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
    <div class="mt-8 md:mt-0 md:order-1 sm:order-1">
      <div class="max-w-lg mx-auto">
        <h2 class="text-2xl font-extrabold tracking-tight text-gray-900 sm:text-3xl">Kontakt</h2>
        <dl class="mt-8 text-base text-gray-500">
          <div class="mt-6">
            ...
            <dd class="flex">
              ...
              <span class="ml-3">
                <p>
                  <a class="underline" target="_blank" href="https://goo.gl/maps/fAMmSET8UjPNxNYr5"
                    >Neue Hard 14, 8005 Zürich</a
                  >
                </p>
              </span>
            </dd>
          ...
          <div class="mt-3">
            ...
            <dd class="flex">
              ...
              <span class="ml-3">
                <a class="underline" href="tel:+41789466951"> +41 78 946 69 51 </a>
                <span class="pl-2">(Mo-Fr 9:00 - 18:00)</span>
              </span>
            </dd>
          </div>
          <div class="mt-3">
