...
<div class="bg-gray-900 h-screen relative">
    ...
    <div class="sm:mx-auto sm:max-w-3xl sm:px-6">
      <div class="py-12 sm:relative sm:mt-12 sm:py-16 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
        <div class="relative flex pl-4 sm:mx-auto sm:max-w-3xl sm:px-0 lg:max-w-none lg:h-full lg:pl-5">
          <img src="img/mlink/tree.svg" alt="mlink tree" class="flex-grow mx-16" />
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="relative">
    <div class="relative bg-gray-900">
      ...
      >
        <div>
          <img src="img/mlink/diagram.svg" class="flex-grow" alt="mlink integration" />
        </div>
          ...
          <dl>
            {#each bulletPoints as bulletPoint}
              <div class="flex items-center mt-2">
                <img src="icons/checkmark.svg" alt="checkmark" class="flex-shrink-0 h-6 w-6" />
                <div class="ml-3">
