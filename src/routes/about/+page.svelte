  ...
  let contents: BlockContent[] = [
    {
      ...
      image: {src: 'img/intro/content_team.svg', alt: 'Software Development Team'},
    ...
    },
    {
      ...
      image: {src: 'img/intro/awards.svg', alt: 'Kunde ist König'},
      link: {href: '/reference', text: 'Kundenportfolio'},
    },
  ]
</script>
