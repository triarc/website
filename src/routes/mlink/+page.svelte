    ...
    },
    {
      ...
      cards: [
        ...
        },
        {
          ...
          content: "µLink bietet mit REST und AMQP offene und vielseitige Schnittstellen an. Das Knowhow kann so mit wenig Aufwand intern aufgebaut werden. µLink setzt bewusst auf offene Standards um keine, nur für µLink zu erlernende, Hürde einzuführen."
        },
        {
          title: "Sicherheit",
          content: "Sämtliche Kommunikation erfolgt ausschliesslich via HTTPS und TLS und bedarf einer Authentifizierung. Die Komponenten von µLink sind hochverfügbar und erlauben einen Ausfall von einzelnen Containern, ohne die Funktion zu mindern. Es besteht die Möglichkeit µLink in ein Monitoring System für kritische Systeme zu integrieren. µLink bietet Möglichkeiten zur Kontrolle des Zugriffs und der Verwendung der Schnittstellen durch Umsysteme. Sogar Daten lassen sich benutzerspezifisch maskieren."
        },
        {
          title: "Versionierung",
          content: "Die von µLink für die Umsysteme zur Verfügung gestellte Schnittstelle ist versionssicher, d.h. Anpassungen und Updates am ERP führen nicht zu Tests und Anpassungen an allen abhängigen Systemen, sondern beschränken sich auf µLink. Die Komplexität der Kommunikation wird mit dem ERP gekapselt. "
        },
        {
          title: "Kosteneffizienz",
          content: "Integratoren bewegen sich immer nur im Umfeld ihrer Applikation, somit fällt der grösste Teil der Einarbeitungskosten und Koordinationsaufwand weg. Wird ein angebotenes System ausgetauscht, muss nur die Schnittstelle zu µLInk entwickelt werden. \n" +
