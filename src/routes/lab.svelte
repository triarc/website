        ...
        <div class="mt-20">
          <div class="mt-6 lg:max-w-xl">
            ...
            <p class="mt-6 text-xl text-gray-500">
              Wilkommen im Lab von triarc.
              Hier erfährst du mehr zu den entstandenen Produkten, welche wir im Rahmen des Labs entwickeln.
        ...
        <div class="mt-20">
          <div class="mt-6 lg:max-w-xl">
            ...
            <p class="mt-4 text-lg text-gray-100 italic">
              Slothi soll deine Terminprobleme lösen.
              Eine smarte Lösung, welche dir den passenden Termin für alle Teilnehmer findet.
            </p>
            <p class="mt-4 text-lg text-gray-300">
              Damit du möglichst eifach einen Termin planen kannst, wählst du den Zeitraum in welchem der Termin stattfinden soll.
              Die erforderliche Zeitdauer und die Teilnehmer welche daran teilnehmen sollen.
              Ab da übernimmt Slothi für dich und prüft die Verfügbarkeiten aller Teilnehmer.
              Du erhälst eine Auswahl an möglichen Terminvorschlägen und kannst einen fixen Termin einplanen.
            </p>
        ...
        <div class="mt-20">
          <div class="mt-6 lg:max-w-xl">
            ...
            <p class="mt-4 text-lg text-gray-700 italic">
              Fair Pizza soll Restaurants eine einfache Alternative bieten, um Ihre Angebot selbständig Online zu verkaufen.
            </p>
            ...
            <div class="mt-6 mb-12">
              <div class="flex space-x-4">
                ...
                <a href="https://demo.fairpizza.ch" class='text-red-500 px-6 py-2' target="_blank">
                  Demo
                </a>
              </div>
            </div>
