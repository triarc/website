...
<!--		<img src='img/office/bar.png' class='absolute right-0 w-1/2'/>-->
			...
			<div class="relative pt-12 pb-8 sm:pt-24 sm:pb-64 xl:col-start-1 xl:pb-24">
				...
				<div class="mt-12 grid grid-cols-1 gap-y-12 gap-x-6 sm:grid-cols-2">
					<p>
						...
						<span class="mt-1 block text-base text-gray-300">Weil uns deine Zeit, so wichtig wie dir ist. Flexible Arbeitszeit inklusive 5 Wochen Ferien.</span>
					</p>

					<p>
						<span class="block text-2xl font-bold text-white">Transparenz</span>
						<span class="mt-1 block text-base text-gray-300">Dies gilt für das Lohnsystem inklusive Unternehmenfragen.</span>
					</p>
					...
					<p>
						<span class="block text-2xl font-bold text-white">Holokratie</span>
						<span class="mt-1 block text-base text-gray-300">Deine Stimme zählt, entscheide mit über Themen die dich und andere beschäftigen.</span>
					</p>
					...
					<p>
						...
						<span class="mt-1 block text-base text-gray-300">Wähle dein Setup das zu dir passt.</span>
					</p>

					<p>
						<span class="block text-2xl font-bold text-white">Home-Office</span>
						<span class="mt-1 block text-base text-gray-300">Für die regnerischen Tage im Trainer</span>
					</p>

					<p>
						<span class="block text-2xl font-bold text-white">Office Gym</span>
						<span class="mt-1 block text-base text-gray-300">Damit du in Form bleibst</span>
					</p>

					<p>
						<span class="block text-2xl font-bold text-white">Company Events</span>
						<span class="mt-1 block text-base text-gray-300">Vom Legobauen bis zum Festival oder eine Reise nach Italien</span>
					</p>
				</div>
			</div>
		</div>
			...
			<div class="relative pt-12 pb-16 sm:pt-24 sm:pb-64 xl:col-start-2 xl:pb-24">
				...
				<div class="mt-12 grid grid-cols-1 gap-y-12 gap-x-6 sm:grid-cols-2 text-right">
					...
					<p>
						...
						<span class="mt-1 block text-base text-gray-300">Du kannst im Team arbeiten sowie kommunizieren und das auch auf English</span>
					</p>

					<p>
						<span class="block text-2xl font-bold text-white">Erfahrung</span>
						<span class="mt-1 block text-base text-gray-300">Du hast einen abgeschlossen IT-Ausbildung oder vergleichsweise Arbeitserfahrung in der Entwicklung</span>
					</p>

					<p>
						<span class="block text-2xl font-bold text-white">Begeisterung</span>
						<span class="mt-1 block text-base text-gray-300">Dir macht die Entwicklung Freunde und verstehst warum Clean-Code wichtig ist. Neuem gegenüber bist du stehts offen.</span>
					</p>
	...
	<div class="bg-blue-triarc">
		<div class="max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
			...
			<p class="mt-4 text-lg leading-6 text-indigo-200">Du findest du passt zu uns und kannst etwas beisteuern? Entschlüssle den Code und bewirb dich!</p>

			<button disabled on:click={unlock} class="mt-8 w-full inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-blue-triarc bg-white hover:bg-indigo-50 sm:w-auto">
				Unlock me
			</button>
		</div>
	</div>
